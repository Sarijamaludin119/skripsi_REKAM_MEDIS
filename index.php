        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <div class="p-5">
                <img src="assets/logo.png" alt="Logo" width="100cm" style="display: block; margin: 0 auto; text-align: center;">
                  <div class="text-center">
                    <br>
                    <h1 class="h4 text-gray-900 mb-4">Selamat Datang</h1>
                    <h3>SISTEM INFORMASI REKAM MEDIS </h3>
                    <h2>PUSKESMAS PERAWATAN HITU</h2>
                    <br>
                  </div>
                  <form action="admin/login_proses.php"  method="post" enctype="multipart/form-data">
