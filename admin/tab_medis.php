...
<div class="container-fluid">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Data Tenaga Medis Puskesmas:</h6>
    </div>
    <!-- Card Body -->
    <div class="card-body">
      <?php
      ...
      <div class="row mt-3">
        <div class="col-md-8  mt-4">
          ...
          <a href="export_medis.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mt-1"><i
            ...
            while ($row = mysqli_fetch_array($brg)) {
              ...
              <tbody>
                <tr>
                  ...
                  <td>&nbsp;<a href="edit_medis.php?id=<?php echo $row['id']; ?>"><button type="button"
                        class="btn btn-success">Edit</button></a> &nbsp; <a
                      href="hapus_medis.php?id=<?php echo $row['id']; ?>"><button type="button"
                        class="btn btn-danger">Hapus</button></a> &nbsp; <a
                      href="detail_medis.php?id=<?php echo $row['id']; ?>"><button type="button"
